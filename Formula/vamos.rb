class Vamos < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kwaimind/vamos/releases/download/v0.4.0/vamos-0.4.0-darwin-arm64.tar.gz"
      sha256 "9a9e6e7b665f06c434e9914e3f4b348a1fc07919e5a53505a183ea39d0e2b73c"
    else
      url "https://github.com/kwaimind/vamos/releases/download/v0.4.0/vamos-0.4.0-darwin-amd64.tar.gz"
